...
## Looker generates one PDF per email - this gets spammy if a stakeholder
## needs multiple reports.
...
for user in user_id:
    def email_gen():
        ...
        sender_email = "alan.leung@generic-email.com"
        receiver_email = "alan.leung@generic-email.com"
        ...
        message["From"] = "alan.leung@generic-email.com"
        message["To"] = "alan.leung@generic-email.com"
